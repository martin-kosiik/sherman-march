...
dep_var_vec <- c("pdem1900", "thur1948", "share_southern_names_1930_pct", "pct_conf_streets_surname")
...
oster_2019_est_deltas(dep_var = "share_southern_names_1930_pct")
...
rownames(betas_df) <- c("Democrats' share in 1900", "Thurmond's share in 1948", "Confederate first names share-1930 census",
                        "Confederate streets share" )
...
#  kable_styling(font_size = 8) %>%
 # column_spec(1, bold = that_cell) %>% 
  add_header_above(c("Bias-adj. treament effect" = 3, "Strength of sel. on unob. ($\\delta$)" = 3)) %>% 
